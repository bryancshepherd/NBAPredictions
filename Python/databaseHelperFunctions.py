...
def addTables(db_file):
    ...
    c.execute('CREATE TABLE schedule (game_date text, game_time text, away_team text, away_score int, home_team text, home_score int, overtime_indicator int, notes text)')
